...
-- Paso 1: Crear PerfilUsuario sin la llave foránea a Usuario
...
-- Paso 2: Crear Usuario con la llave foránea a PerfilUsuario
...
-- Paso 3: Alterar PerfilUsuario para agregar la llave foránea a Usuario
ALTER TABLE PerfilUsuario
ADD CONSTRAINT FK_PerfilUsuario_Usuario FOREIGN KEY (documentoUsuario) REFERENCES Usuario(documento);
